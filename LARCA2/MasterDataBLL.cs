...
namespace LARCA2.Business.Services
{
    public class MasterDataBLL
    {
        ...
        public List<LARCA20_MasterData> FiltroId(long id)
        {
            return MasterDataDAL.FiltroId(id);
        }
        ...
        public List<LARCA20_MasterData> TodosFiltro(string tx1, string tx2)
        {
            return MasterDataDAL.TodosFiltro(tx1, tx2);
        }
