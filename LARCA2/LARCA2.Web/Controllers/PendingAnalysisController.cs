...
namespace Larca2.Controllers
{
    public class PendingAnalysisController : Controller
    {
        public ActionResult Index()
        {
            ...
            ViewData["MasterRows"] = new SMOScopeBLL().Todos().Where(smo => smo.O_C.ToUpper() == "O" && (smo.ActionPlan != null || smo.Why1 != null || smo.Why2 != null | smo.Why3 != null)).ToList();
            return View(model);
        }

        public ActionResult Export()
        {
            var masterData = new SMOScopeBLL().Todos().Where(smo => smo.O_C == string.Empty || smo.O_C == null || smo.O_C == "O" || smo.O_C == "o").ToList();
