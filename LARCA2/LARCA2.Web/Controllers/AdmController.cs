    ...
    public class AdmController : Controller
    {
                ...
                if (CboRoles != "0")
                {
                    if (LosPermisos[0] != "")
                    {
                        ...
                        else
                        {
                            ...
                            return Content("<script language='javascript' type='text/javascript'>alert('Se ha modificado el registro correctamente');document.location = '../Adm/UserBM';</script>");
                        }
                    }
                    else
                    {
        ...
        public ActionResult ModificarAuxData(Larca2.Models.AuxDataSearchForm model)
        {
            if (ModelState.IsValid)
            {
                ...
                user.TopLvl2 = model.AuxData.TopLvl2;
                user.TopLvl3 = model.AuxData.TopLvl3;
                user.Toplvl4 = model.AuxData.Toplvl4;
                user.XlsRowFrom = model.AuxData.XlsRowFrom;
                user.XlsColumnFrom = model.AuxData.XlsColumnFrom;
                user.CntAdjuntos = model.AuxData.CntAdjuntos;
