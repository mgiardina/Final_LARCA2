...
namespace Larca2.Models
{
    public class Level4SearchForm
    {
        ...
        public List<LARCA2.Data.DatabaseModels.LARCA20_Level4> Level4EditedList { get; set; }
        public List<LARCA2.Data.DatabaseModels.LARCA20_MasterData> Level3List { get; set; }
